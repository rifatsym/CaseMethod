...
public class SPBU {
    ...
    public SPBU() {
        ...
        transaksiQueue = new QueueTransaksi(100); // kapasitas maksimal riwayat transaksi
    }
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    System.out.print("Masukkan jenis kendaraan (motor/mobil/lain): ");
                ...
                case 3:
                    ...
                    if (dipanggil != null) {
                        ...
                        Transaksi t = new Transaksi(dipanggil.nomorPlat, jenisBBM, liter, harga);
                        t.tampilkanStruk();
